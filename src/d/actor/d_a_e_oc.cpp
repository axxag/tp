...
void daE_OC_c::executeWait() {
    ...
    switch (mOcState) {
        case 0:
            ...
            if (field_0x6b4 == 0) {
                if (cM_rnd() < 0.1f) {
                    field_0x6c0 = (cM_rndF(20.0f) + 10.0f) * SCALE_TIME;
                    mOcState = 1;
                } else {
                    field_0x6c0 = (cM_rndF(30.0f) + 50.0f) * SCALE_TIME;
                    mOcState = 3;
                }
        ...
        case 2:
            if (searchPlayerShakeHead()) {
                ...
                if (mpMorf->isStop()) {
                    ...
                    mSound.startCreatureVoice(Z2SE_EN_OC_V_WAIT, -1);
                    if (field_0x6b4 == 0) {
                        field_0x6c0 = (cM_rndF(10.0f) + 10.0f) * SCALE_TIME;
                        mOcState = 3;
                    } else if (home.pos.abs(current.pos) > 100.0f) {
                        field_0x6c0 = (cM_rndF(10.0f) + 10.0f) * SCALE_TIME;
                        mOcState = 3;
                    } else {
                        field_0x6c0 = (cM_rndFX(30.0f) + 300.0f) * SCALE_TIME;
                        mOcState = 1;
...
void daE_OC_c::executeWalk() {
    ...
    switch (mOcState) {
        case 0:
            ...
            field_0x6c0 = (cM_rndFX(50.0f) + 150.0f) * SCALE_TIME;
            mOcState = 1;
            if (field_0x6b4 == 0) {
...
void daE_OC_c::executeTalk() {
    ...
    switch (mOcState) {
        case 0:
            ...
            field_0x6c0 = (cM_rndF(30.0f)) * SCALE_TIME;
            mOcState = 1;
        ...
        case 1: {
            ...
            if (rand_val < 0.2f) {
                ...
                mOcState = 2;
                field_0x6c0 = (cM_rndF(30.0f) + 30.0f) * SCALE_TIME;
            } else {
                setBck(0x18, 2, 5.0f, 1.0f);
                mSound.startCreatureVoice(Z2SE_EN_OC_V_STAND_WAIT, -1);
                mOcState = 2;
        ...
        switch (mOcState) {
            ...
            case 2:
                ...
                if (mOcState == 0) {
                    ...
                    if (field_0x6e2) {
                        field_0x6c0 = l_HIO.demo_waiting_time * SCALE_TIME;
                    } else {
                        field_0x6c0 = (cM_rndF(10.0f) + 20.0f) * SCALE_TIME;
                    }
                    ...
                    field_0x6c0 = (cM_rndF(5.0f) + 5.0f) * SCALE_TIME;
                    setBck(0xd, 0, 5.0f, 1.0f);
                    mSound.startCreatureVoice(Z2SE_EN_OC_V_FIND, -1);
                }
        ...
        case 4:
            ...
            if (mpMorf->isStop()) {
                if (health < 1) {
                    ...
                    onDownFlg();
                    setStabPos();
                    field_0x6c0 = (cM_rndFX(10.0f) + 45.0f) * SCALE_TIME;
                }
            }
            break;
        case 5:
...
void daE_OC_c::executeWatch() {
    ...
    switch (mOcState) {
        case 0:
            ...
            field_0x6c0 = (s8) (cM_rndFX(15.0f) + 35.0f) * SCALE_TIME;
            mOcState = 1;
        case 1:
...
void daE_OC_c::executeSoundWatch() {
    ...
    switch (mOcState) {
        case 0:
            ...
            setBck(0xd, 0, 5.0f, 1.0f);
            mSound.startCreatureVoice(Z2SE_EN_OC_V_FIND, -1);
            field_0x6c0 = (cM_rndF(30.0f) + 60.0f) * SCALE_TIME;
            mOcState = 1;
        case 1:
            if (field_0x6c0 == 0) {
                setBck(0xb, 2, 5.0f, 1.2f);
